...
class ViewController: UIViewController {
	let movies = [
        Movie(imageView: UIImageView(image: UIImage(named: "")), rating: 3, title: "1", subtitle: "1", description: "", titleColor: .red),
        Movie(imageView: UIImageView(image: UIImage(named: "")), rating: 3, title: "2", subtitle: "2", description: "", titleColor: .red),
        Movie(imageView: UIImageView(image: UIImage(named: "")), rating: 3, title: "3", subtitle: "3", description: "", titleColor: .red),
        Movie(imageView: UIImageView(image: UIImage(named: "")), rating: 3, title: "4", subtitle: "4", description: "", titleColor: .red)
